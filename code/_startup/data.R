...
# activity / bone CSV: n = 1,007, with one canonical `industrial_index`
# column. It excludes the 75 participants of village_id 43, whose bone-density
# ultrasound was measured on an uncalibrated system. Derives rescaled columns so
...
read_csv(here("data", "processed", "Orang-Asli-pa-vs-bone-60126.csv"),
  ...
  mutate(
    ...
    # body mass, entered as two separate regression covariates.
    # Z-scoring keeps the b ~ student_t(3, 0, 2.5)
