...
# lognormal) given daily step count (rescaled to /1000). t2(age, steps)
# tensor smooth + DAG-implied adjustment {sex,
# pregnant_or_breastfeeding_n_y_0_1, functional_status_n_y_0_1}. Reads
