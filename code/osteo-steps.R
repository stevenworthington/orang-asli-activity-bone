###############################################################################
# Causal AERF/AMEF for serum osteocalcin (pg/mL, outcome scaled /10,000, lognormal)
# given daily step count (scaled /5,000).
# t2(age, steps) tensor smooth + DAG-implied adjustment set
...
# Smoke-test mode: `SAMPLING_MODE=smoke Rscript code/osteo-steps.R` overrides
