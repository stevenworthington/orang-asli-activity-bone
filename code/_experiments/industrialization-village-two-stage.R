###############################################################################
# Industrialization analysis: standardized village-level two-stage meta-GAM.
# This is the primary estimator for the industrialization analyses, with
# inference at the level the exposure actually varies.
#
...
#
# Uncertainty is honest by construction (N = #villages). The `se()` plug-in
# treats adj_se as known; industrialization-village-two-stage-propagated.R
# carries the stage-1 draws through instead and shows the reported quantities
# are unchanged.
#
# ISOLATED: writes only to outputs/_experiments/industrialization-village-two-stage/.
...
cat("\nDone — per-spec summaries in", out_dir, "\n")
