...
# all-cohort fit, not a high-precision per-subgroup point estimate.
#
# Outputs:
...
amef_subset_draws <- function(fit, spec_key, age_group) {
  ...
  # Population-average AMEF within the subgroup, matching aerf_draws() /
  # amef_draws() in code/_startup/pipeline-helpers.R.
