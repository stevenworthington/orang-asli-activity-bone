...
# valid proxy for all nine analyses, and the far more expensive full Bayesian
# suite is unnecessary.
#
...
#
# DGP parameters are estimated Bayesianly (two brms multilevel fits, one-time),
# so this calibration involves no frequentist estimation at all. Datasets are simulated on the REAL
...
#
# Run: Rscript code/_experiments/calibration-sos-bayesian.R
