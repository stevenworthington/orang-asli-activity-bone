###############################################################################
# Causal AERF/AMEF for serum osteocalcin (pg/mL, rescaled to /10000,
# lognormal) given mean daily ENMO (mg). t2(age, ENMO) tensor smooth +
# DAG-implied adjustment
# {sex, pregnancy/lactation, smoking, alcohol, functional status, village identity}. Reads formula / priors / MCMC config from
