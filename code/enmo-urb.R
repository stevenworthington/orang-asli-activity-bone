###############################################################################
# Industrialization -> mean daily ENMO (mg). t2(age, industrial_index)
# tensor smooth + minimal adjustment {sex}. Reads formula / priors / MCMC
# config from the registry in
