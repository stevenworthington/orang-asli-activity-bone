...
%   \lnode{<node style>}   \ledge{<colour>}   \ledgedash{<colour>}
...
\node[anno, align=center] (msascap) at (4.3, -2.6)
  {MSAS = \{ Age, Sex, Pregnancy/lactation, Smoking/alcohol,\\ Functional status, community identity \}};
